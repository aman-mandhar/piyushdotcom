...
class EditProperty extends Component
{
    use WithFileUploads;
   // Common Fields 
    public $property_title, $slug, $propertyId;
    ...
    public function mount($id)
    {
        ...
        $this->current_image = $property->image;

        // Populate all fields from existing property record
        $this->fill($property->toArray());

        // Optional: transform video_link back to watch?v=... if needed

        // Your dropdowns
        $this->cities = City::all();
        $this->property_types = ['Plot', 'House', 'Apartment', 'Villa', 'Office', 'Shop', 'Agriculture Land'];
        $this->listing_types = ['Sale', 'Rent', 'Lease', 'Collaborate'];
        $this->plot_categories = ['Residential', 'Commercial', 'Industrial'];
        $this->furnishing_statuses = ['Furnished', 'Semi-Furnished', 'Unfurnished'];
        $this->directions = ['North', 'South', 'East', 'West'];
        $this->prices_in = ['Lakh', 'Crore', 'Thousand', 'Millon', 'Billon', 'Trillion'];
    ...
    public function updateProperty()
    {
        ...
        $imagePath = $this->image
            ? $this->image->store('properties', 'public')
            : $property->image;
