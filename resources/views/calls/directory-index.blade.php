...
@section('title', 'Directory Call History')
@section('content')
<div class="container py-4">
    <h2 class="mb-4">📞 Directory Call History</h2>
        ...
        <tbody>
            @forelse ($calls as $index => $call)
                <tr>
                    ...
                    <td>
                        @if($call->property_id)<a href="{{ route('property.show', $call->property_id) }}" class="btn btn-primary">View Property</a>
                        @elseif($call->vehicle_id)<a href="{{ route('vehicle.show', $call->vehicle_id) }}" class="btn btn-primary">View Vehicle</a>
