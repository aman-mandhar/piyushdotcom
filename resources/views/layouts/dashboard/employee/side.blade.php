...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li>
            <a class="active-menu"  href="{{ route('employee.dashboard') }}"><i class="fa fa-tachometer"></i> Dashboard</a>
        </li>
        ...
        <li>
            <a href="{{route('employee.calls.index')}}"><i class="fa fa-phone"></i> Calls</a>
        </li>
        
        <li>
            <a href="{{route('employee.calls.property')}}"><i class="fa fa-home"></i>My Properties</a>
        </li>	
        
        <li>
            <a href="{{route('employee.calls.vehicle')}}"><i class="fa fa-car"></i>My Vehicles</a>
        </li>
        
        <li>
            <a href="{{route('employee.calls.directory')}}"><i class="fa fa-building"></i>My Directory List</a>
        </li>				
