<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    @if ($property_type === 'Plot')
        ...
        <div>
            ...
            <select wire:model="plot_type" class="w-full border rounded px-3 py-2">
                <option value="">Select</option>
        ...
        <div>
            ...
            <input type="text" wire:model="plot_number" class="w-full border rounded px-3 py-2">
        </div>

        <div><label>Front</label><input type="number" step="0.01" wire:model="plot_front" class="w-full border rounded px-3 py-2"></div>
        <div><label>Back</label><input type="number" step="0.01" wire:model="plot_back" class="w-full border rounded px-3 py-2"></div>
        <div><label>Side 1</label><input type="number" step="0.01" wire:model="plot_side_1" class="w-full border rounded px-3 py-2"></div>
        <div><label>Side 2</label><input type="number" step="0.01" wire:model="plot_side_2" class="w-full border rounded px-3 py-2"></div>
        <div>
            <label>Total Area (auto)</label>
            <input type="text" wire:model="plot_size" class="w-full border rounded px-3 py-2 bg-gray-100" readonly>
        </div>
        <div>
            <label>Price Per Sq. Ft.</label>
            <input type="number" step="0.01" wire:model="price_per_sqft" class="w-full border rounded px-3 py-2">
        </div>
    @endif
    ...
    @if ($property_type === 'Office')
        ...
        <div><label>Office Area Size</label><input type="number" step="0.01" wire:model="office_area_size" class="w-full border rounded px-3 py-2"></div>
        <div>
            <label>Furnishing Status</label>
