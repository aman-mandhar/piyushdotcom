<div class="container py-4">
    <h4 class="text-2xl font-bold mb-4">Post Your Vehicle for Sale</h4>
    ...
    <form wire:submit.prevent="save" enctype="multipart/form-data">
        ...
        <div class="form-check mb-3">
            <input type="checkbox" class="form-check-input" wire:model.lazy="any_accident" id="accidentCheckbox">
        ...
        <!-- Loan Info -->
        <div class="form-check mb-3">
            <input type="checkbox" class="form-check-input" wire:model.lazy="loan_running" id="loanCheckbox">
        ...
        <div class="mb-3">
            ...
            @if ($featured_image)
                <div class="mt-3">
                    ...
                    <img src="{{ $featured_image->temporaryUrl() }}" class="img-thumbnail" style="max-height: 200px;">
                </div>
            @endif
        </div>
